<nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-mp">
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ route('home') }}"><img class="navbar-brand-full" src="/images/logo-white.svg" height="30" alt="Laravel Admin"></a>
